...
<body>
    ...
    <section class="ptb-100">
        ...
        <div class="container">
            <h2> Series &amp; Movies in your Wishlist</h2>
            <br>
            <div class="row">
                <div class="col-12">
                    <h2>Series</h2>
                ...
                $sql = "SELECT series.SeriesId, SeriesName, Episodes, Seasons, Duration, Description,Year, Category FROM series INNER JOIN serieswish ON series.SeriesId = serieswish.seriesID AND serieswish.userID= '$id'";
                ...
                if ($result = mysqli_query($link, $sql)) {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        echo '<div class="alert alert-danger"><em>No whishlisted series were found.</em></div>';
                    }
                } else {
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    $sql = "SELECT  movies.MovieId, moviename, Duration, Description, Year, Category FROM movies INNER JOIN moviewish ON movies.MovieId = moviewish.movieID  AND moviewish.userID= '$id'";
                    ...
                    if ($result = mysqli_query($link, $sql)) {
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            echo '<div class="alert alert-danger"><em>No wishlisted movies were found.</em></div>';
                        }
                    } else {
                        echo "Oops! Something went wrong. Please try again later.";
                    }
