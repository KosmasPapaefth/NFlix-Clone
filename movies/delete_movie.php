...
if (isset($_POST["MovieId"]) && !empty($_POST["MovieId"])) {
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        ...
        // Set parameters
        $param_MovieId = trim($_POST["MovieId"]);
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="MovieId" value="<?php echo trim($_GET["MovieId"]); ?>" />
                            <p>Do you sure you want to delete this record?</p>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger">
                                <a href="../company_index.php" class="btn btn-secondary">No</a>
                            </p>
                        </div>
                    </form>
                </div>
